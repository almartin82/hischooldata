...
# Theme and colors are defined here for reference but all code blocks
# use portable inline values (theme_minimal, hex strings) so README
# code blocks can match verbatim.
```
